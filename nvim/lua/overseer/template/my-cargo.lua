...
local commands = {
  {
    args = { "nextest", "run", "--profile=ci", "all-features", "--release", "--workspace" },
    tags = { TAG.TEST },
    env = { RUST_LOG = "info", CI = "true" },
    comp = { "default" },
  },
  {
    args = { "clippy", "--workspace", "--all-features", "--tests" },
    env = {},
    comp = { { "on_output_quickfix", open_on_match = true }, "default" },
  },
  { args = { "fmt", "--all" }, env = {}, comp = { "default" } },
}
